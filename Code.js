/************************************************************
FODE ADMISSIONS ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â STAGING SCRIPT (PORTAL + DRIVE UPLOADS + ALLOWLIST)
...
var AUTHORITATIVE_DOWNSTREAM_DEPLOYMENT_ID = "AKfycbwLz4rLrVzk-NriJAovTbifpg8YpQguFJiY-l02qkRrahH1ayX_2qBh3bk_rc8dVnPp";
...
function doPost(e) {
  ...
  try {
    ...
    logActivation_(logSheet, "TOKEN_TRACE_REACHED", {
      downstream_deployment_id: "AKfycbwLz4rLrVzk-NriJAovTbifpg8YpQguFJiY-l02qkRrahH1ayX_2qBh3bk_rc8dVnPp",
      correlation_id: cid,
      applicantId: applicantId || "",
      formId: formId || "",
...
function renderPortalHtml_(opts) {
  ...
  return ''
    ...
    // ÃƒÂ¢Ã…â€œÃ¢â‚¬Â¦ hardcoded action URL to prevent blank screen / doPost not firing
...
function ensureHeaders_(sheet, payload) {
  ...
  // ÃƒÂ¢Ã…â€œÃ¢â‚¬Â¦ NEW ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â verification tracking
...
function test_LogSheetWrite() {
  ...
  // Minimal write first (donÃƒÂ¢Ã¢â€šÂ¬Ã¢â€žÂ¢t push a 50-column row until we confirm wiring)
